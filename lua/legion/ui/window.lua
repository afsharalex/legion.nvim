...
function M.capture_input(opts)
  opts = opts or {}
  local title = opts.title or "Legion Prompt"
  ...
  vim.bo[buf].filetype = "legion_prompt"
  ...
  vim.wo[win].winhl = "Normal:Normal,FloatBorder:LgnPromptBorder,FloatTitle:LgnPromptTitle"
...
function M.notify(msg, level)
  ...
  vim.notify(msg, level, { title = "Legion" })
end
